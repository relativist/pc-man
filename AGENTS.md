...
- Не заводить задачи в bd пока не попросят.
- Не выходить за пределы workspace
- Не использовать sudo
- Не выполнять команды, требующие сеть, без запроса
- Все изменения только в текущем проекте
- В рамках рабочей дириктории вноси изменения смело, и не спрашивать разрешения на изменения. 